...
public interface IProgressMonitor {
	...
	/**
	 * Sets current progress. <B>Please note this value is between 0 and
	 * max_progress. You need to scale it yourself in order to get progress
	 * information between 0 and 100.</B>
	 *
	 * @param progress
	 *            New progress value
	 ...
	 *
	 * @param status
	 *            - Status message to display to user near progress bar (e.g.
	 *            "Downlading library net.minecraft:launchwrapper:0.1")
	 */
